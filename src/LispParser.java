...
public class LispParser extends Parser {
	...
	public static final int
		...
		OR=36, NOT=37, EQUAL=38, NOTEQUAL=39, LT=40, GT=41, LE=42, GE=43, NUMBER=44, 
		TRUE=45, FALSE=46;
	public static final int
	...
	public final Lisp_Context lisp_() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 123145371533312L) != 0) );
			setState(27);
			match(EOF);
			}
		}
	...
	public final ConditionalContext conditional() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 123145371533312L) != 0)) {
					{
					setState(61);
					expression();
					}
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			setState(114);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 123145304424448L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
